...
class DetailViewModel @Inject constructor(
    ...
    override fun createInitialState(): DetailContract.DetailUiState =
        DetailContract.DetailUiState(state = DetailContract.DetailState.Loading)
    ...
    private fun removeBookmark(item: PhotoEntities.Document){
        viewModelScope.launch {
            ...
            setEffect { DetailContract.DetailSideEffect.ShowToast(R.string.bookmark_remove) }
    ...
    private fun saveBookmark(item: PhotoEntities.Document){
        viewModelScope.launch {
            ...
            setEffect { DetailContract.DetailSideEffect.ShowToast(R.string.bookmark_save) }
        }
    }
