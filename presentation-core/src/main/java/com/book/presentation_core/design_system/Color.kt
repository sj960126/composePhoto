...
val lightColors: ColorSystem = ColorSystem(
    ...
    bg01 = Color(0xFFF2F4F5),
    bg02 = Color(0xFFFFFFFF),
    primary = Color(0xFFF3554B),
    secondary = Color(0xFFEE7C63),
    tertiary = Color(0xFF454A53),
    tintPrimary = Color(0xFFF3554B),
    tintSecondary = Color(0xFFFFFFFF),
    tintTertiary = Color(0xFF1A1C20),
    tintQuaternary = Color(0xFFFFFFFF),
    b01 = Color(0xFF579CF0),
    b02 = Color(0xFF6AC1B9),
    b03 = Color(0xFF4D5256),
    transparent = Color(0),
...
val darkColors: ColorSystem = ColorSystem(
    ...
    bg01 = Color(0xFF161718),
    bg02 = Color(0xFF222326),
    primary = Color(0xFFDC473E),
    secondary = Color(0xFFEE7C63),
    tertiary = Color(0xFF454A53),
    tintPrimary = Color(0xFF404247),
    tintSecondary = Color(0xFFFFFFFF),
    tintTertiary = Color(0xFF1A1C20),
    tintQuaternary = Color(0xFFDC473E),
    b01 = Color(0xFF579CF0),
    b02 = Color(0xFF6AC1B9),
    b03 = Color(0xFF7E8183),
    transparent = Color(0),
    dimMax = Color(0xFF000000),
    dimHigh = Color(0xB3000000),
    dimMid = Color(0x7F000000),
